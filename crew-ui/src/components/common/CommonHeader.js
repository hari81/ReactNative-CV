            ...
            return (
                <View style={{flexDirection: 'row', height: '6%', backgroundColor: 'rgb(35,43,50)', zIndex: 1}}>
                    ...
                    <View style={{
                        ...
                        <Image style={{width: width * 0.074, height: height * 0.044, marginTop: 2, marginRight: 10}}
                               source={Logo}/>
                        <Text style={{color: '#fefefe', fontFamily: 'HelveticaNeue', fontSize: 10, marginTop: 18}}>PRICE
                            HEDGING</Text>
                    </View>

                    <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center'}}>
                        <TouchableHighlight onPress={this.props.onPress}>
                            <Image style={{width: width * 0.019, height: height * 0.026, marginTop: 5, marginRight: 5}}
                                   source={this.props.refreshImg}/>
                        </TouchableHighlight>
                        <Text style={{
                    ...
                    <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center'}}>
                        <View style={{
                            ...
                            <Text
                                style={{color: '#fff', fontFamily: 'HelveticaNeue-Light', fontSize: 14, marginTop: 5}}>1-952-742-7414</Text>
                        </View>
                        <Text style={{color: '#ffffff35', fontFamily: 'HelveticaNeue-Thin', fontSize: 20}}> | </Text>
                        <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                            <Image style={{width: width * 0.031, height: height * 0.0416, marginLeft: 20}}
                                   source={User}/>
                            <TouchableHighlight onPress={this.logOffPress}>
                                <Image source={require('./img/ExpandArrow.png')}
                                       style={{width: 10, height: 10, marginLeft: 10, marginTop: 10, marginRight: 20}}/>
                            </TouchableHighlight>
                        </View>
                    </View>
                    {this.sideMenuShow()}
...
const mapStateToProps = (state) => {
    return {
        farmFlag: state.myFar.farmFlag, acc: state.account
    };
};
