...
const styles = {
    ...
    resetPasswordContainer: { zIndex: 15, position: 'absolute', marginTop: height * 0.16, marginLeft: width * 0.25, width: width * 0.4, backgroundColor: 'rgb(239,244,247)', borderColor: '#ddd', borderWidth: 2, borderRadius: 3 }
}
