...
import { invalidateSession } from '../../redux/actions/InvalidateSessionAction';
            ...
            return(
                <View style={styles.resetPasswordContainer}>
                    ...
                    <View style={{ flexDirection: 'row', marginHorizontal: 20, marginVertical: 10 }}>
                       <Button onPress={() => console.log('Hello')} buttonStyle={{ flex: 1, backgroundColor: '#01aca8', borderRadius: 5, borderWidth: 1, borderColor: '#01aca8', marginRight: 10 }}>{'Submit'}</Button>
...
export default connect(null, { invalidateSession })(SideMenuBar);
