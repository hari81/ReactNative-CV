            ...
            <View style={styles.container}>
                ...
                <View>
                    <View style={{flexDirection:'row',marginTop:10}}>
                        ...
                        <TouchableOpacity disabled = {this.props.selectedProduct.productId===107||this.state.btnBuyStatus? true:false}  onPress={()=>this.setState({radioBTNEnableSell:false,radioBTNEnableBuy:true})}><Image style={{ width: 32, height: 32 }} source={this.state.radioBTNEnableBuy?selectedRadioBTN:normalRadioBTN}/></TouchableOpacity>
