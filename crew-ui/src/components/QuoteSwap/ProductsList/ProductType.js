                ...
                <View style={styles.container}>
                        ...
                        <View style={{ width: 252, height: 50, backgroundColor: '#fff', flexDirection: 'row' }}>
                            <View style={{ width: 200, marginTop: 8, marginLeft: 8 }}>
                                <Text style={{ color: '#9f9f9f', fontFamily: 'HelveticaNeue', textAlign: 'auto', fontSize: 16, alignSelf: 'stretch' }}>{this.props.selectedProduct.productName || productInitial}</Text>
                            </View>
