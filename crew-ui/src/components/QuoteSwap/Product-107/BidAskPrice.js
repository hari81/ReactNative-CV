...
const styles = {
    pricesContainer: { flexDirection: 'row', marginTop: 5, marginBottom: 20, width: 480, height: 55, backgroundColor: '#5d6d79', padding: 40, paddingTop: 8, paddingBottom: 8, zIndex: -1 },
