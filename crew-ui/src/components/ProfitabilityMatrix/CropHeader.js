    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <View style={{ width: 1, marginLeft: width * 0.24, marginRight: width * 0.00683, marginTop: height * 0.019, height: height * 0.0611, backgroundColor: 'rgb(221,221,221)' }} />
                <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: 136 }}>
                    ...
                    <Text style={{ fontSize: 20, paddingLeft: 7, color: 'rgb(255,255,255)' }}>{common.minusBeforeDollarSign(this.props.basisEstimate, 2)}</Text>
