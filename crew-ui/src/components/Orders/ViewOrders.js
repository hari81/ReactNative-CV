          ...
          return (
              <View style={styles.subContainerStyle}>
                  <View style={[styles.yearStyle, {width: '10.74%'}]}>
                      ...
                      >
                          <Text
                              style={{fontSize: 14, color: 'white', textAlign: 'center', fontFamily: 'HelveticaNeue'}}>
                              {month}
                          </Text>
                      </View>
                      <View
                  ...
                  <View style={{width: '21.48%'}}>
                      <View style={{margin: 10}}>
                          <Text style={[{
                              ...
                              fontSize: 20
                          }, (crop.length + riskProductName.length) >= 18 ? {fontSize: 16} : {}]}>
                          ...
                          <View style={{flexDirection: 'row', marginTop: 20, justifyContent: 'space-between'}}>
                              <View style={{flexDirection: 'column'}}>
                                  <Text style={[{
                                      ...
                                      fontSize: 12
                                  }, (crop.length + riskProductName.length) >= 18 ? {paddingTop: 8} : {}]}>QUANTITY</Text>
                              ...
                              <View style={{flexDirection: 'column'}}>
                                  <Text style={[{
                                      ...
                                      fontFamily: 'HelveticaNeue',
                                      fontSize: 12
                                  }, (crop.length + riskProductName.length) >= 18 ? {paddingTop: 8} : {}]}>DIRECTION</Text>
                                  <Text style={{fontFamily: 'HelveticaNeue-Thin', fontSize: 14}}>
                                      {buySell}
                                  </Text>
                              </View>
                  ...
                  >
                      ...
                      <Text
                          style={{color: 'rgb(1,172,168)', fontFamily: 'HelveticaNeue', fontSize: 12, paddingTop: 14}}>PRICE</Text>
                  ...
                  >
                      ...
                      <Text
                          style={{color: 'rgb(1,172,168)', fontFamily: 'HelveticaNeue', fontSize: 12, paddingTop: 14}}>ORDER
                          TYPE</Text>
                  ...
                  >
                      <Text style={{color: 'rgb(1,172,168)', fontFamily: 'HelveticaNeue', fontSize: 12}}>CREATION
                          DATE</Text>
                      <Text style={{fontFamily: 'HelveticaNeue-Thin', fontSize: 14}}>
                          {strDate}
                      </Text>
                      <Text
                          style={{color: 'rgb(1,172,168)', fontFamily: 'HelveticaNeue', fontSize: 12, paddingTop: 14}}>
                          VALID UNTIL
                      </Text>
                      <Text style={{fontFamily: 'HelveticaNeue-Thin', fontSize: 14}}>
                          {expirationDate}
